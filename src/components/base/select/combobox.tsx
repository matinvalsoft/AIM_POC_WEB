                ...
                <>
                    ...
                    <div className="relative flex w-full items-center gap-2">
                        ...
                        <AriaInput
                            ...
                            className="z-10 w-full appearance-none bg-transparent text-md text-transparent caret-alpha-black/90 placeholder:text-placeholder focus:outline-hidden disabled:cursor-not-allowed disabled:placeholder:text-disabled"
                        />
                    </div>
